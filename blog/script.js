...
let blogName = "lake sleep blog";
let authorName = "lake";
let authorLink = "http://lakesleep.ing/"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
[ "posts/2026-03-23-mansion-on-the-cliff.html" ],
[ "posts/2026-03-23-glittering-metals.html" ],
[ "posts/2026-03-05-relating-to-the-infinite.html" ] ];
...
'<li><a href="/index.html">back to main site</a></li> </ul>';
...
let footerHTML = '<hr style="height:1px;color:white;"><p><img src="' + relativePath + '/images/water_dividers_transparent_3.png" style="object-fit: scale-down;"/></p>';
...
if ( postsArray.length < 2 ) {
  ...
  nextprevHTML = '<a href="' + relativePath + '/blogindex.html">blog home</a> | <a href="'+ relativePath + '/' + prevlink +'">previous post \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a href="' + relativePath + '/' + nextlink +'">\u00AB next post</a> | <a href="' + relativePath + '/blogindex.html">blog home</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a href="' + relativePath + '/'+ nextlink +'">\u00AB next post</a> | <a href="' + relativePath + '/blogindex.html">blog home</a> | <a href="' + relativePath + '/'+ prevlink +'">previous post \u00BB</a>';
}
